...
We use the three predictors and shared dates defined in Section~4.1 (Appendix~\ref{app:accuracy}). Chronos-2 weights remain frozen \citep{ansari2025chronos2}; its selector is task-trained. This tests acceptance within each pipeline, not training-matched backbone superiority.
