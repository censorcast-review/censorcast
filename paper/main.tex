...
\input{external_v13_main_table.tex}
...
AI assisted with English translation and grammar checking, writing, proofs, experimental design, implementation, and analysis. The authors take full responsibility for the work.
...
\input{earlier_menu_results.tex}
\input{matched_appendix.tex}
\input{revision_v7_appendix.tex}
\input{revision_v9_appendix.tex}
\input{revision_v12_results_appendix.tex}
\input{revision_v12_theory.tex}
\FloatBarrier
\input{appendix_n_v13.tex}
\end{document}
